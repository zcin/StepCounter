...
public class StepCounter {
	...
	public StepCounter(double[] times, double[][] sensorData, int numberSteps) {
		...
		else if(STANDARD_DEVIATION < 1.7) this.PEAK_TROUGH_DIFFERENCE_THRESHOLD = 2.5*STANDARD_DEVIATION - .15;
		
		if(STANDARD_DEVIATION > 2.2) this.NEAR_MISS_THRESHOLD = .6*STANDARD_DEVIATION - 1.0;
		else if(STANDARD_DEVIATION < 2.2) this.NEAR_MISS_THRESHOLD = .05*STANDARD_DEVIATION;
